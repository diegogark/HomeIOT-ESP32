...
A separação das atividades em tarefas permite trabalhar em uma atividade específica do programa facilitando a manutenção e aprimoramentos. A criação de uma tarefa no FreeRTOs pode ser observada abaixo. Ela se comporta de uma forma parecida com o conjunto "Setup" e "Loop" que usamos na IDE do arduino.
